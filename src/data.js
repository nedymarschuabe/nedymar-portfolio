const pt = {
  ...
  experiences: [
    {
      ...
      description:
        "Responsável pela sustentação, análise e desenvolvimento de soluções voltadas ao ambiente hospitalar utilizando o sistema MV e banco de dados Oracle.",
      bullets: [
    ...
    },
    {
      ...
      description:
        "Análise de regras de negócio, investigação técnica de objetos de banco (PL/SQL, T-SQL e PL/pgSQL) e automação de processos corporativos.",
      bullets: [
    ...
    },
    {
      ...
      description:
        "Atuei como desenvolvedor responsável por integrações críticas em ambiente hospitalar, com foco em Oracle PL/SQL, performance e qualidade de dados.",
      bullets: [
    ...
    },
    {
      ...
      location: "Tapejara, Rio Grande do Sul, Brasil",
      description:
        "Suporte técnico, levantamento de requisitos e melhorias de processos, incluindo a Fábrica de Ração (ambiente 100% automatizado).",
      bullets: [
  ...
  education: [
    {
      ...
      degree: "Análise e Desenvolvimento de Sistemas, Information Technology",
      period: "fevereiro de 2021 - dezembro de 2023",
    },
    {
      school: "Unyleya",
      degree: "Inteligência Artificial em Serviços de Saúde, Information Technology",
  ...
  labels: {
    ...
    pdfFile: "/Nedymar-Schuabe-Curriculo.pdf",
  },
};
...
const en = {
  ...
  experiences: [
    {
      ...
      description:
        "Responsible for support, analysis, and development of solutions for the hospital environment using the MV system and Oracle database.",
      bullets: [
    ...
    },
    {
      ...
      description:
        "Analysis of business rules, technical investigation of database objects (PL/SQL, T-SQL, and PL/pgSQL), and automation of corporate processes.",
      bullets: [
    ...
    },
    {
      ...
      location: "Passo Fundo, RS",
      description:
        "Worked as the developer responsible for critical integrations in the hospital environment, focused on Oracle PL/SQL, performance, and data quality.",
      bullets: [
    ...
    },
    {
      ...
      location: "Tapejara, Rio Grande do Sul, Brazil",
      description:
        "Technical support, requirements gathering, and process improvements, including the Feed Mill (a fully automated environment).",
      bullets: [
  ...
  education: [
    ...
    {
      school: "Unyleya",
      degree: "Artificial Intelligence in Healthcare Services, Information Technology",
  ...
  labels: {
    ...
    pdfFile: "/Nedymar-Schuabe-Resume-EN.pdf",
  },
};
